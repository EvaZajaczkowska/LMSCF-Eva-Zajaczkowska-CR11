...
$resAni = mysqli_query($conn,"SELECT * FROM animals WHERE category='small' OR  category='large'");
...
<body>
	<header>
		...
		<nav class="nav nav-pills flex-column flex-sm-row">
			...
			<a class="flex-sm-fill text-sm-center nav-link active" href="general.php">Small and Big Animals</a>
