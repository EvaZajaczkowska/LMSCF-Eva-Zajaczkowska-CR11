...
$resAni = mysqli_query($conn,"SELECT * FROM animals WHERE category='senior'");
...
<body>
	<header>
		...
		<nav class="nav nav-pills flex-column flex-sm-row">
			...
			<a class="flex-sm-fill text-sm-center nav-link active" href="senior.php">Senior Animals</a>
